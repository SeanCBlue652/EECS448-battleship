...
// There are numberOfShips ships to place for each player, each with a ship size
// 1x(1 to NumberOfShips)
...
// Which direction do you want this ship to face? ('N' for North, 'E' for East,
...
// enter coordinates
// if attack hits, update attack history with hit spot then check if there’s any
// more battleship spots on player 2’s board array
...
// if illegal input, print "Sorry, that is not a valid menu option." then
// display menu choices again
...
// enter coordinates
// if attack hits, update attack history with hit spot then check if there’s any
// more battleship spots on player 1’s board array
// if there are no ship spots left, then win
// If attack misses, update attack history with miss spot
// Type "2" to review your board
